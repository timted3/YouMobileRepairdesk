...
public class MainActivity extends AppCompatActivity
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot messageSnapshot : dataSnapshot.getChildren()) {
                    ...
                    String model = (String) messageSnapshot.child("phone").child("model").getValue();
                    String brand = (String) messageSnapshot.child("phone").child("brand").getValue();
                    String imei = String.valueOf(messageSnapshot.child("phone").child("imei").getValue());
                    //Ticket t = messageSnapshot.getValue(Ticket.class);
                    tickets.add(key + " " + status + " " + brand + " " + model + " " + imei);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            System.out.println("Test deze shit yo");
